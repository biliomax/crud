...
<form name="cadcliente" id="cadcliente" method="post" action="">
    ...
    <section class="row" id="cadastro">
        ...
        <div class="col-md-4">
            <label>Senha:</label>
            <input type="password" value="{$CLI_PASS}" name="cli_senha" class="form-control" required readonly>
        </div>

        <div class="col-md-4">
            <label>Divida:</label>
            <input type="text" value="{$CLI_DIVIDA}" name="cli_divida" class="form-control" required>
        </div>
