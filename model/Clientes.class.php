...
class Clientes extends Conexao
{
    ...
    function Preparar($cli_nome, $cli_sobrenome, $cli_data_nasc, $cli_rg,
                      ...
                      $cli_hora_cad, $cli_senha, $cli_divida)
    {
    ...
    function Inserir()
    {
        ...
        $query .= " cli_cidade ,cli_uf ,cli_cep ,cli_email ,cli_data_cad, cli_hora_cad, cli_pass, cli_divida)";
        $query .= " VALUES ";
        $query .= " (:cli_nome, :cli_sobrenome,:cli_data_nasc,:cli_rg,";
        $query .= " :cli_cpf, :cli_ddd,:cli_fone,:cli_celular ,:cli_endereco ,:cli_numero,:cli_bairro ,";
        $query .= " :cli_cidade ,:cli_uf ,:cli_cep ,:cli_email ,:cli_data_cad, :cli_hora_cad, :cli_senha, :cli_divida)";
    ...
    function Alterar($id)
    {
        ...
        $query .= " cli_cidade=:cli_cidade ,cli_uf=:cli_uf ,cli_cep=:cli_cep ,cli_email=:cli_email ,cli_data_cad=:cli_data_cad, cli_hora_cad=:cli_hora_cad, cli_pass=:cli_senha, cli_divida=:cli_divida";
    ...
    function AlterarADM($id)
    {
        ...
        $query = " UPDATE {$this->prefix}clientes SET cli_nome=:cli_nome, cli_sobrenome=:cli_sobrenome,cli_data_nasc=:cli_data_nasc,cli_rg=:cli_rg,";
        $query .= " cli_cpf=:cli_cpf, cli_ddd=:cli_ddd,cli_fone=:cli_fone,cli_celular=:cli_celular ,cli_endereco=:cli_endereco ,cli_numero=:cli_numero,cli_bairro=:cli_bairro ,";
        $query .= " cli_cidade=:cli_cidade ,cli_uf=:cli_uf ,cli_cep=:cli_cep ,cli_email=:cli_email, cli_pass=:cli_senha, cli_divida=:cli_divida";
        $query .= " WHERE  cli_id = :cli_id";
    ...
    /*** @param int $id do clientes que vai apagar */
...
// GETTERS retornando os dados do cliente 
    ...
    public function getCli_divida()
    {
        return $this->cli_divida;
    }
    ...
    public function setCli_divida($cli_divida)
    {
        $this->cli_divida = $cli_divida;
    }
