    ...
    <div class="row" id="adm_topo">
        ...
        <div class="container">
            ...
            <div class="col-md-6">
                ...
                {*<img src="{$GET_TEMA}/images/adm_logo.png" alt="">*}
            </div>
            ...
            <div class="col-md-6 text-right">
                ...
                {if $LOGADO == true}
                    <h4>
                        Olá: {$USER} <a href="{$PAG_LOGOFF}" class="btn btn-danger "><i
                                    class="glyphicon glyphicon-log-out"></i> Sair </a>
                        <a href="{$PAG_SENHA}" class="btn btn-warning "><i class="glyphicon glyphicon-asterisk"></i>
                            Alterar Senha </a>
                        <br>
                        <br>
                    </h4>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="{$PAG_ADM_PEDIDOS}"><i class="glyphicon glyphicon-shopping-cart"></i> Pedidos </a>
                        </li>
